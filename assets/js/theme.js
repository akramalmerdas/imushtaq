   ...
   /*------------------------------------------------------
    ...
    if ($clientTestimonial01.length > 0) {
        var $clientTestimonial01_obj = $clientTestimonial01.owlCarousel({
            autoplay: true,
            autoplayTimeout: 1000, // Time between slides in ms (default is 5000)
            autoplaySpeed: 300,    // Slide transition speed in ms (default is 500)
            smartSpeed: 300,        // Animation speed in ms (default is 250)
            loop: true,
            nav: false,
            dots: false,    
            responsiveClass: true,
